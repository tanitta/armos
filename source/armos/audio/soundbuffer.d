module armos.audio.soundbuffer;
...
class SoundBuffer {
    public{
        ...
        ///
        SoundBuffer loadWav(string path){
            import std.file;
        ...
        ///
        SoundBuffer loadWav(ubyte[] buffer){
            load(buffer.decodeWave);
            return this;
        }
        
        ///
        SoundBuffer load(Wave wave){
            import std.conv;
        ...
        ///
        SoundBuffer loadOgg(string path){
            DerelictOgg.load();
            DerelictVorbis.load();
        ...
        ///
        SoundBuffer range(in float startSec, in float finishSec){
            _start  = startSec;
            _finish = finishSec;
        ...
        ///
        SoundBuffer detectBpm(in size_t bufferSize, in BpmDetectionSource sourceType = BpmDetectionSource.Beats)
        in{
